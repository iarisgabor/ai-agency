...
const METRICS = [
  { value: '48h', label: 'Timp mediu de livrare pentru un site' },
  { value: '100+', label: 'Afaceri locale analizate' },
  { value: '24/7', label: 'Automatizări active pentru clienți' },
]

export default function Metrics() {
  return (
    <section id="rezultate" className="relative min-h-screen w-full overflow-hidden bg-black">
      <video
        src={VIDEO_URL}
        autoPlay
        muted
      ...
      <div className="relative z-10 mx-auto flex max-w-6xl flex-col px-6 pt-32 pb-32">
        <motion.p
